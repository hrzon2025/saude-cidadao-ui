...
-- First, drop the foreign key constraint from enderecos
ALTER TABLE public.enderecos DROP CONSTRAINT IF EXISTS enderecos_usuario_id_fkey;

-- Drop the existing primary key constraint with CASCADE
ALTER TABLE public.usuarios DROP CONSTRAINT usuarios_pkey CASCADE;
