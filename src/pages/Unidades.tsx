...
const Unidades = () => {
  ...
  const filteredUnidades = mockUnidades.filter(unidade =>
    unidade.nome.toLowerCase().includes(searchQuery.toLowerCase()) ||
    unidade.endereco.toLowerCase().includes(searchQuery.toLowerCase())
  );

  const handleVerNoMaps = (unidade: any) => {
    // Simular abertura do Google Maps
    const { lat, lng } = unidade.geo;
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex items-center p-4 bg-primary text-primary-foreground">
        ...
        <h1 className="text-xl font-semibold ml-2">Postos de Vacinação</h1>
      </div>
      ...
      <div className="flex-1 p-4 space-y-4">
        ...
        <div className="relative">
          ...
          <Input
            type="text"
            placeholder="Busque por uma unidade ou endereço..."
            value={searchQuery}
            ...
            <Card key={unidade.id} className="overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-4 space-y-3">
                  ...
                  {/* Botão Ver no Maps */}
                  <Button
                    onClick={() => handleVerNoMaps(unidade)}
                    variant="outline"
